...
public final class TaskDao_Impl implements TaskDao {
  ...
  public TaskDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTask = new EntityInsertionAdapter<Task>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `task_table` (`id`,`title`,`description`,`due_date`) VALUES (nullif(?, 0),?,?,?)";
      }
    ...
    this.__updateAdapterOfTask = new EntityDeletionOrUpdateAdapter<Task>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR ABORT `task_table` SET `id` = ?,`title` = ?,`description` = ?,`due_date` = ? WHERE `id` = ?";
      }
  ...
  public LiveData<List<Task>> getAllTasks() {
    final String _sql = "SELECT * FROM task_table ORDER BY due_date";
